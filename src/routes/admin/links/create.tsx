...
import { AlertCircle, ArrowLeft, Link2, Plus } from "lucide-react"
	...
	return (
		<>
			<SEO
				...
				description="Create a new shortened affiliate link with tracking."
				noIndex={true}
			/>
			<div className="w-full">
				<section className="relative overflow-hidden bg-gradient-to-b from-primary/5 via-background to-background py-12">
					<div className="container mx-auto px-4">
						...
						<p className="text-lg text-muted-foreground">
							Add a new shortened affiliate link with tracking
						</p>
					</div>
								...
								<div className="space-y-4">
									<div className="space-y-2">
										...
										<p className="text-sm text-muted-foreground">
											A friendly name for this link (internal use only)
										</p>
									</div>
									...
									<div className="space-y-2">
										...
										<p className="text-sm text-muted-foreground">
											The short URL path (auto-generated from name)
										</p>
									</div>
