...
import { AlertCircle, ArrowLeft, Image, Package } from "lucide-react"
...
export const Route = createFileRoute("/admin/recommended/items/$itemId/edit" as any)({
...
function EditItemPage() {
	...
	const item = useRecommendedItem(itemId as Id<"recommendedItems">)
	const sections = useRecommendedSections()
	const updateItem = useUpdateRecommendedItem()
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			await updateItem({
				clerkId: user.id,
				itemId: itemId as Id<"recommendedItems">,
	...
	return (
		<>
			<SEO
				title="Edit Recommended Item"
				description="Edit a recommended product or tool."
				noIndex={true}
			/>
			<div className="w-full">
