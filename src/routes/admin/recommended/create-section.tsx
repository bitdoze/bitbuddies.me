...
import { AlertCircle, ArrowLeft, FolderPlus, Layers } from "lucide-react"
...
import { useCreateRecommendedSection } from "@/hooks/useRecommendedItems"

export const Route = createFileRoute("/admin/recommended/create-section" as any)({
	component: CreateSectionPage,
})

function CreateSectionPage() {
	const { isAuthenticated, isLoading, isAdmin, user } = useAuth()
	const createSection = useCreateRecommendedSection()
	...
	return (
		<>
			<SEO
				...
				description="Create a new section for recommended items."
				noIndex={true}
			/>
			<div className="w-full">
				<section className="relative overflow-hidden bg-gradient-to-b from-primary/5 via-background to-background py-12">
					<div className="container mx-auto px-4">
						...
						<p className="text-lg text-muted-foreground">
							Add a new section to organize recommended items
						</p>
					</div>
								...
								<div className="space-y-4">
									<div className="space-y-2">
										...
										<p className="text-sm text-muted-foreground">
											The section heading displayed on the site
										</p>
									</div>
