...
Return exactly 10 titles, each on its own line as a valid JSON object.`,
		userPromptTemplate: `Create 10 engaging {platform} titles for content about: {topic}. Tone: {style}. Make them catchy and platform-appropriate. Don't include 'sure' or numbering. Apply the principles and guidelines provided in the system prompt.
...
Rewrite the provided text following all these rules and make it sound completely human-written.`,
		userPromptTemplate: `Rewrite this text to sound natural and human-written while bypassing AI detectors:
...
2. [Question 2]
... (10 total)`,
		userPromptTemplate: `Generate a YouTube script for a video about: {topic}.
...
Return exactly 5 thumbnail ideas, each on its own line as a valid JSON object.`,
		userPromptTemplate: `Generate 5 unique thumbnail ideas for a YouTube video about: {topic}.
