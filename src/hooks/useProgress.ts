 ...
 */
export function useUserCourseProgress(clerkId: string | null | undefined, courseId: Id<"courses"> | undefined) {
	return useQuery(
 ...
 */
export function useEnrollment(clerkId: string | null | undefined, courseId: Id<"courses"> | undefined) {
	return useQuery(
...
export function useLessonCompletion(
	progressRecords: Array<{ lessonId: Id<"lessons">; isCompleted: boolean }> | undefined,
